  ...
  <body>
    ...
    <div class="content m-3">
      ...
      >
        ...
        >
          <p class="text-white m-0 fw-normal module_text">Ezugi Casino</p>
        </div>
        <div
      ...
      <div class="d-flex flex-column align-items-center mt-4">
        ...
        >
          <span>Load More</span>
          <span
            class="overflow-hidden position-absolute top-0 start-0 end-0 bottom-0"
          ></span>
        </button>
      </div>
    </div>
