  ...
  <body>
    ...
    <div class="content m-3">
      ...
      >
        ...
        >
          <p class="text-white m-0 fw-normal module_text">Evolution Casino</p>
        </div>
        <div
      ...
      <div class="row sport_games">
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/es/jpg/es-baccarat-lobby.jpg"
            />
            <h5
              class="card_text"
              style="
        ...
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/es/jpg/es-roulette-lobby.jpg"
            />
            <h5
              class="card_text"
              style="
        ...
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/es/jpg/es-blackjack-lobby.jpg"
            />
            <h5
              class="card_text"
              style="
        ...
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/es/jpg/es-imperial-quest.jpg"
            />
            <h5
              class="card_text"
              style="
        ...
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/es/jpg/es-moneywheel-lobby.jpg"
            />
            <h5
              class="card_text"
              style="
