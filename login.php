...
<html lang="en">
  <head>
    ...
    .style_loginPageContainerThree__231BE .style_loginPageWrapper__D-Su5
    {
    ...
    border-radius: 18px;
      ...
      .one_bet_img_bottom_input img {
        width: 88%;
        height: auto;
      }

      .style_loginPageContainerThree__231BE
        .style_loginPageWrapper__D-Su5
        .style_loginPanelForm__J78ll
        .style_loginBtn__A64b6 {
        background: #00a826;
        border: 0;
        border-radius: 10px;
        font-size: 1rem;
    ...
    <style>
      :where(.css-htwhyh).ant-form-item {
    ...
    <style>
      :where(.css-htwhyh)[class^="ant-input"],
      :where(.css-htwhyh)[class*=" ant-input"] {
        font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto,
          "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji",
          "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
      ...
      :where(.css-htwhyh).ant-input-textarea-show-count .ant-input-data-count {
        position: absolute;
        bottom: -22px;
        inset-inline-end: 0;
      ...
      :where(.css-htwhyh).ant-input-affix-wrapper {
        position: relative;
        display: inline-flex;
        width: 100%;
        min-width: 0;
      ...
      :where(.css-htwhyh).ant-input-affix-wrapper:hover
      {
      ...
      :where(.css-htwhyh).ant-input-affix-wrapper > input.ant-input {
        padding: 0;
        font-size: inherit;
        border: none;
        border-radius: 0;
  ...
  <body>
    <noscript>1oBet – Betting Exchange | UAE</noscript>
    <div id="root">
      <div class="grey-theme" style="position: relative; overflow-x: hidden">
        <div class="grey-theme">
          <div class="grey-theme">
            <div
              class="container-fluid login_inp_bg style_loginPageContainerThree__231BE"
            >
              <div class=" mt row justify-content-center ">
                <div class="style_loginPageWrapper__D-Su5">
                  <img
                    class="one_o_bet_icon_img style_logoLogin__VWH0W"
                    src="data:image/png;base64,"
                    alt="Logo"
                  />
                  <form
                    id="basic"
                    autocomplete="off"
                    class="ant-form ant-form-horizontal css-htwhyh sc-eDDNvR hSGIkP style_loginPanelForm__J78ll"
                  >
                  <label for="Username" class="lable">UserName</label>
                    <div class="form-group emailFormItem css-htwhyh">
                      <span
                         class="ant-input-affix-wrapper styles_dark__xWcaf styles_roundInput__VOk83 loginInputFields css-htwhyh">
                      <span>
                        <input
                          type="text"
                          placeholder="Username"
                          class="form-control ant-input css-htwhyh"
                          style=" box-shadow: none;"
                          value=""
                        />
                      </span>
                    </div>
                    <label for="Username" class="lable">Password</label>
                    <div class="form-group passwordFormItem css-htwhyh">
                       <span
                                class="ant-input-affix-wrapper styles_dark__xWcaf styles_roundInput__VOk83 loginInputFields css-htwhyh"
                      ...
                      <input
                        ...
                        style="box-shadow: none;"
                      />
                      <button class="btn button password_icon" tabindex="0" type="button" fdprocessedid="vipvdl" >
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" font-size="1.25rem" class="iconify iconify--tabler" width="1em" height="1em" viewBox="0 0 24 24">
        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
            <path d="m3 3l18 18M10.584 10.587a2 2 0 0 0 2.828 2.83"></path>
            <path d="M9.363 5.365A9.466 9.466 0 0 1 12 5c4 0 7.333 2.333 10 7c-.778 1.361-1.612 2.524-2.503 3.488m-2.14 1.861C15.726 18.449 13.942 19 12 19c-4 0-7.333-2.333-10-7c1.369-2.395 2.913-4.175 4.632-5.341"></path>
                    ...
                    <div class="form-group">
                      <button
                        type="button"
                        class="btn  ant-btn css-htwhyh ant-btn-default  style_loginBtn__A64b6"
                      >
                        Login
                      </button>
                    </div>
                  </form>
                  <div class="one_bet_img_bottom_input">
                    <img
                      src="/public/assets/icons/default-logo.webp"
                      alt="Logo"
                    />
                  </div>
                  <button
                    type="button"
                    class="btn  ant-btn css-htwhyh ant-btn-default our_policies"
                  >
                    OUR POLICIES
                  </button>
                </div>
