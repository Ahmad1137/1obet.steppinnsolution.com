...
<head>
    ...
    <title>120 British Casino</title>
    ...
    <div class="content m-3">
        ...
        <div class="heigt_sport_book m-0 d-flex flex-row flex-grow-0 position-relative w-100">
            <div class="triangle_left d-flex pl-4 pr-4 align-items-center position-relative">
                <p class="text-white m-0 fw-normal module_text">120 British Casino</p>
            </div>
            <div
        ...
        <div class="row sport_games">
            <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
                <div class="card">
                    <img class="w-100"
                        src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/ez/jpg/ez-cumbia-ruleta-1.jpg" />
            ...
            <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
                <div class="card">
                    <img class="w-100"
                        src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/ez/jpg/ez-ezugi-live-roulette-lobby.jpg" />
                    <h5 class="card_text" style="
                text-align: center;
                background: linear-gradient(
                  rgba(125, 185, 232, 0),
            ...
            <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
                <div class="card">
                    <img class="w-100"
                        src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/ez/jpg/ez-video-blackjack.jpg" />
                    <h5 class="card_text" style="
                text-align: center;
                background: linear-gradient(
                  rgba(125, 185, 232, 0),
            ...
            <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
                <div class="card">
                    <img class="w-100"
                        src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/ez/jpg/ez-roulette-gold-2.jpg" />
                    <h5 class="card_text" style="
                text-align: center;
                background: linear-gradient(
                  rgba(125, 185, 232, 0),
            ...
            <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
                <div class="card">
                    <img class="w-100"
                        src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/ez/jpg/ez-dealer-roulette-thai.jpg" />
                    <h5 class="card_text" style="
                text-align: center;
                background: linear-gradient(
                  rgba(125, 185, 232, 0),
            ...
            <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
                <div class="card">
                    <img class="w-100"
                        src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/es/jpg/es-poker-lobby.jpg" />
                    <h5 class="card_text" style="
                text-align: center;
                background: linear-gradient(
                  rgba(125, 185, 232, 0),
            ...
            <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
                <div class="card">
                    <img class="w-100"
                        src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/es/jpg/es-top-games-lobby.jpg" />
                    <h5 class="card_text" style="
                text-align: center;
                background: linear-gradient(
                  rgba(125, 185, 232, 0),
            ...
            <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
                <div class="card">
                    <img class="w-100"
                        src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/es/jpg/es-game-shows-lobby.jpg" />
                    <h5 class="card_text" style="
                text-align: center;
                background: linear-gradient(
                  rgba(125, 185, 232, 0),
        ...
        <div class="d-flex flex-column align-items-center mt-4">
            <button
                class="load_btn w-20 m-0 rounded d-inline-flex align-items-center justify-content-center position-relative"
                type="button">
                <span>Load More</span>
                <span class="overflow-hidden position-absolute top-0 start-0 end-0 bottom-0"></span>
            </button>
        </div>
    </div>
