  ...
  <body>
    ...
    <div class="content m-3">
      ...
      >
        ...
        >
          <p class="text-white m-0 fw-normal module_text">Sport Book</p>
        </div>
        <div
      ...
      <div class="row sport_games">
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/di/jpg/di-live-betting.jpg"
            />
            <h5
              class="card_text"
              style="
        ...
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/di/jpg/di-esports.jpg"
            />
            <h5
              class="card_text"
              style="
        ...
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/di/jpg/di-sportsbook.jpg"
            />
            <h5
              class="card_text"
              style="
