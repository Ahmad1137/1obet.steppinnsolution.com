  ...
  <body>
    ...
    <div class="content m-3">
      ...
      >
        ...
        >
          <p class="text-white m-0 fw-normal module_text">Betfair Games</p>
        </div>
        <div
      ...
      <div class="row sport_games">
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/bf/jpg/bf-vintage-win.jpg"
            />
            <h5
              class="card_text"
              style="
        ...
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/bf/jpg/bf-golden-new-world.jpg"
            />
            <h5
              class="card_text"
              style="
        ...
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/bf/jpg/bf-best-new-york-food.jpg"
            />
            <h5
              class="card_text"
              style="
        ...
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/bf/jpg/bf-fruitastic.jpg"
            />
            <h5
              class="card_text"
              style="
        ...
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/bf/jpg/bf-royal-win.jpg"
            />
            <h5
              class="card_text"
              style="
        ...
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/bf/jpg/bf-magic-hunter.jpg"
            />
            <h5
              class="card_text"
              style="
        ...
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/bf/jpg/bf-golden-lamp.jpg"
            />
            <h5
              class="card_text"
              style="
        ...
        <div class="pt-4 pl-4 col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="card">
            <img
              class="w-100"
              src="https://d1b82hscw3e9o2.cloudfront.net/media/images/slots/small/bf/jpg/bf-pagoda-of-fortune.jpg"
            />
            <h5
              class="card_text"
              style="
